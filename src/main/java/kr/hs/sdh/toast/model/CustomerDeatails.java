...
public class CustomerDeatails extends User {
    ...
    public CustomerDeatails(final Customer customer, final List<BankAccount> bankAccounts) {
        ...
        this.email = customer.getPeople().getIdentity();
